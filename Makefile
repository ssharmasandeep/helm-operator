...
# example.com/helm-operator-bundle:$VERSION and example.com/helm-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= example.com/helm-operator
...
IMG ?= sandeepaarna/helm-operator:latest
